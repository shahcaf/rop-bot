...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        try {
            ...
            if (res.rows.length === 0) return interaction.reply({ content: 'Giveaway not found or not yet ended.', ephemeral: true });
            ...
            if (entries.size === 0) return interaction.reply({ content: 'No entries to reroll from!', ephemeral: true });
